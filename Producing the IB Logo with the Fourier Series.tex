...
Let's add \(n\) and \(2\pi\) to the exponent in Equation \textbf{(\ref*{eq:euler})} such
...
Lastly, let's multiply the entire exponent by the variable \(c_n\) to get \(c_n e^{n \cdot 2\pi it}\). This will not
